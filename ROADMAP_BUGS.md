...
### BUG-35: Thinking detection before tokenizer creation (main_train.py:212) — FIXED
- **File:** `main_train.py` lines 137, 212, 233-234
- **Severity:** CRITICAL
...
### BUG-36: Division by zero in loss computation (main_train.py:479) — FIXED
- **File:** `main_train.py` line 479
- **Severity:** HIGH
...
### BUG-37: Thinking phase consumes all generation budget (dialogmanager.py:235) — FIXED
- **File:** `dialogmanager.py` lines 231-236
- **Severity:** HIGH
...
| File | Bugs |
|------|------|
| `main_train.py` | BUG-35, BUG-36 |
| `dialogmanager.py` | BUG-37 |
