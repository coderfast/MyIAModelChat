...
CATEGORY_KEYWORDS = {
    ...
    'weather': ['WEATHER', 'RAIN', 'SUN', 'CLOUDY', 'HOT', 'COLD', 'TEMPERATURE', 'FORECAST'],
    ...
    'weather': ['WEATHER', 'RAIN', 'SUN', 'CLOUD', 'STORM', 'SNOW', 'WIND', 'TEMPERATURE'],
...
class AIMLParser:
    ...
    def _normalize(self, pattern: str, template: str) -> dict:
        ...
        # Build input_ids as "PATTERN: RESPONSE"
        input_ids = f"{clean_pattern}: {clean_template}"
